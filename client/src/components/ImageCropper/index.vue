...
export default {
    ...
    methods: {
        ...
        // 剪裁前准备工作
        startCrop() {
            let that = this, {width, height, ratio, scale, sourceImgUrl, sourceImgMasking, lang} = that;
            let sim = sourceImgMasking, img = new Image();
        ...
        createImg(e) {
            let that = this;
            let {mime, sourceImg, scale: {x, y, width, height, degree}, sourceImgMasking: {scale}} = that;
        ...
        upload() {
            let that = this;
            let {lang, imgFormat, mime, url, params, headers, field, ki, createImgUrl, withCredentials} = this;
